...
Reads the manual brain masks and calculates the DICE score for a series of generated brain masks based on the
likelihood maps predicted by the u-net architecture.
"""
...
def likelihood_hist(likelihood_array):
